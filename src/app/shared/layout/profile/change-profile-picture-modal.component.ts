...
import { Component, Injector, ViewChild, ChangeDetectorRef, ElementRef } from '@angular/core';
...
export class ChangeProfilePictureModalComponent extends AppComponentBase {
    ...
    imageCropped(event: ImageCroppedEvent) {
        if (event.blob) {
            let file = new File([event.blob], "profile-picture.png", { type: "image/png" });
            let files: File[] = [file];
            this.uploader.clearQueue();
