...
import { AttachFileServiceProxy, CM_ATTACH_FILE_INPUT, CM_ATTACH_FILE_ENTITY } from '@shared/service-proxies/service-proxies';
import { GetFileMultiModel } from './attach-file-dto';
...
export abstract class DefaultComponentBase extends ChangeDetectionComponent {
    ...
    constructor(injector: Injector) {
        ...
        this.cacheRouteReuseStrategy = injector.get(RouteReuseStrategy) as CacheRouteReuseStrategy;
    ...
    addFileEditTable(input: any, type: string, refIds) {
    ...
    updateFileEditTable(input: any, type: string, refIds) {
    ...
    getFileEditTable(refMasterId: string, master: any) {
        this.attachFileService.cM_ATTACH_FILE_By_RefMaster(refMasterId).subscribe(response => {
