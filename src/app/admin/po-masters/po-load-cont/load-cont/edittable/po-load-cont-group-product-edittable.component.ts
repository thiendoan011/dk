...
import { PO_GROUP_PRODUCT_ENTITY, PO_LOAD_CONT_ENTITY } from "@shared/service-proxies/service-proxies";

@Component({
    selector: 'po-load-cont-group-product-edittable',
	templateUrl: './po-load-cont-group-product-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POLoadContGroupProductEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
