...
@Component({
    selector: 'po-coststatement-production-dt',
	templateUrl: './po-coststatement-production-dt.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POCoststatementDTProductionComponent extends ChangeDetectionComponent implements AfterViewInit {
