...
@Component({
    selector: 'po-coststatement-production-latest-dt',
	templateUrl: './po-coststatement-production-latest-dt.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POCoststatementProductionLatestDTComponent extends ChangeDetectionComponent implements AfterViewInit {
