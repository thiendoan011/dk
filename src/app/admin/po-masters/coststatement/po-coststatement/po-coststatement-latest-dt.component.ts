...
@Component({
    selector: 'po-coststatement-latest-dt',
	templateUrl: './po-coststatement-latest-dt.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POCoststatementLatestDTComponent extends ChangeDetectionComponent implements AfterViewInit {
