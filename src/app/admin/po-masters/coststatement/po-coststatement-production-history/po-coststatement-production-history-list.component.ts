...
@Component({
    templateUrl: './po-coststatement-production-history-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoCostStatementProductionHistoryListComponent extends ListComponentBase<PO_COSTSTATEMENT_HISTORY_ENTITY> implements IUiActionList<PO_COSTSTATEMENT_HISTORY_ENTITY>, OnInit, AfterViewInit {
...
//#region constructor
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoCostStatementProductionHistory', true, true, false, true, true, true, false, true);
...
//#region search and navigation
    ...
    onAdd(): void {
        this.navigatePassParam('/app/admin/po-coststatement-production-history-add', null, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onUpdate(item: PO_COSTSTATEMENT_HISTORY_ENTITY): void {
        this.navigatePassParam('/app/admin/po-coststatement-production-history-edit', { id: item.coststatemenT_HISTORY_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onViewDetail(item: PO_COSTSTATEMENT_HISTORY_ENTITY): void {
        this.navigatePassParam('/app/admin/po-coststatement-production-history-view', { id: item.coststatemenT_HISTORY_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
