...
@Component({
    selector: 'r-attach-file',
	templateUrl: './r-attach-file.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class RAttachFileComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ...
    _hiddenEditButton: boolean;
    @Input() set hiddenEditButton(value: boolean) {
        this._hiddenEditButton = value;
    }
//#endregion "Constructor"   
    ...
    onUpdateFile(){
        ...
        this.attachFile.cM_TYPE = 'PO_MASTER/R';
