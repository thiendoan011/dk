...
@Component({
    templateUrl: './po-producted-part-4-edit.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class PoProductedPart4EditComponent extends DefaultComponentBase implements OnInit, AfterViewInit, IUiActionRejectExt<PO_ENTITY> {
    ...
    ngOnInit(): void {
        ...
        switch (this.editPageState) {
            case EditPageState.add:
                ...
                this.appToolbar.setRole('PoProductedPart4', false, false, true, false, false, false, false, false);
            ...
            case EditPageState.viewDetail:
                this.disablePoEdit = true;
                this.appToolbar.setRole('PoProductedPart4', false, false, false, false, false, false, true, false);
    ...
    goBack() {
        this.navigatePassParam('/app/admin/po-producted-part-4', null, { filterInput: JSON.stringify(this.filterInput) });
    }
        ...
        this.poProductedPartDetailService
			...
			.subscribe((res) => {
				if (res['Result'] != '0') {
					...
					this.updateSuccess();
                    // CM_ATTACH_FILE
					this.updateFile(this.inputModel, 'po-producted-part-4', undefined, this.inputModel.pO_PRODUCTED_PART_ID);
                    this.getPoProductedPartDetail();
                    this.updateView();
				}
			});
    ...
    onStartProductedPart(){
        abp.ui.setBusy()
        this.poProductedPartDetailService
			.pO_PRODUCTED_PART_DETAIL_Start(this.inputModel.pO_ID, "CD4", "Sơn 2")
