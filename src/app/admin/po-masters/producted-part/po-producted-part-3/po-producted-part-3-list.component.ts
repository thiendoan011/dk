...
@Component({
    templateUrl: './po-producted-part-3-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoProductedPart3ListComponent extends ListComponentBase<PO_ENTITY> implements IUiAction<PO_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoProductedPart3', true, true, false, true, true, true, false, true);
    ...
    search(): void {
        ...
        this.filterInputSearch.pO_PRODUCTED_PART_CODE = 'CD3'
    ...
    onStartProductedPart(record: PO_ENTITY){
        ...
        this.poProductedPartDetailService
			.pO_PRODUCTED_PART_DETAIL_Start(record.pO_ID, "CD3", "Sơn 1")
    ...
    onUpdate(item: PO_ENTITY): void {
        this.navigatePassParam('/app/admin/po-producted-part-3-edit', { po_id: item.pO_ID, producted_part_code: item.pO_PRODUCTED_PART_CODE }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: PO_ENTITY): void {
        this.navigatePassParam('/app/admin/po-producted-part-3-view', { po_id: item.pO_ID, producted_part_code: item.pO_PRODUCTED_PART_CODE }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
