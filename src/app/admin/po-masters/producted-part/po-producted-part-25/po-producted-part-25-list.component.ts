...
import { CM_BRANCH_ENTITY, BranchServiceProxy, AsposeServiceProxy, ReportInfo, PoProductServiceProxy, PO_ENTITY, PoProductedPartDetailServiceProxy, } from "@shared/service-proxies/service-proxies";
...
@Component({
    templateUrl: './po-producted-part-25-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoProductedPart25ListComponent extends ListComponentBase<PO_ENTITY> implements IUiAction<PO_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoProductedPart25', true, true, false, true, true, true, false, true);
    ...
    search(): void {
        ...
        this.filterInputSearch.pO_PRODUCTED_PART_CODE = 'CD25'
    ...
    onStartProductedPart(record: PO_ENTITY){
        ...
        this.poProductedPartDetailService
			.pO_PRODUCTED_PART_DETAIL_Start(record.pO_ID, "CD25", "Lắp ráp")
    ...
    onUpdate(item: PO_ENTITY): void {
        this.navigatePassParam('/app/admin/po-producted-part-25-edit', { po_id: item.pO_ID, producted_part_code: item.pO_PRODUCTED_PART_CODE }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: PO_ENTITY): void {
        this.navigatePassParam('/app/admin/po-producted-part-25-view', { po_id: item.pO_ID, producted_part_code: item.pO_PRODUCTED_PART_CODE }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
