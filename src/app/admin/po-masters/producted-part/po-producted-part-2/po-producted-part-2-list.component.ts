...
@Component({
    templateUrl: './po-producted-part-2-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoProductedPart2ListComponent extends ListComponentBase<PO_ENTITY> implements IUiAction<PO_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoProductedPart2', true, true, false, true, true, true, false, true);
    ...
    search(): void {
        ...
        this.filterInputSearch.pO_PRODUCTED_PART_CODE = 'CD2'
    ...
    onStartProductedPart(record: PO_ENTITY){
        ...
        this.poProductedPartDetailService
			.pO_PRODUCTED_PART_DETAIL_Start(record.pO_ID, "CD2", "Định hình")
    ...
    onUpdate(item: PO_ENTITY): void {
        this.navigatePassParam('/app/admin/po-producted-part-2-edit', { po_id: item.pO_ID, producted_part_code: item.pO_PRODUCTED_PART_CODE }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: PO_ENTITY): void {
        this.navigatePassParam('/app/admin/po-producted-part-2-view', { po_id: item.pO_ID, producted_part_code: item.pO_PRODUCTED_PART_CODE }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
