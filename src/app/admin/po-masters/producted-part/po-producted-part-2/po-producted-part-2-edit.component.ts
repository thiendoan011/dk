import { Component, Injector, ViewChild, OnInit, ViewEncapsulation, ElementRef, AfterViewInit, Output, EventEmitter } from '@angular/core';
import { appModuleAnimation } from '@shared/animations/routerTransition';
import * as _ from 'lodash';
import { CM_DEPARTMENT_ENTITY, UltilityServiceProxy, PO_ENTITY, PoProductedPartDetailServiceProxy, PO_PRODUCTED_PART_ENTITY } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './po-producted-part-2-edit.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class PoProductedPart2EditComponent extends DefaultComponentBase implements OnInit, AfterViewInit, IUiActionRejectExt<PO_ENTITY> {
    ...
    constructor(
        ...
        this.inputModel.pO_PRODUCTED_PARTs_DETAIL = [];
        this.initFilter();
    ...
    ngOnInit(): void {
        ...
        switch (this.editPageState) {
            case EditPageState.add:
                ...
                this.appToolbar.setRole('PoProductedPart2', false, false, true, false, false, false, false, false);
            ...
            case EditPageState.viewDetail:
                this.disablePoEdit = true;
                this.appToolbar.setRole('PoProductedPart2', false, false, false, false, false, false, true, false);
    ...
    goBack() {
        this.navigatePassParam('/app/admin/po-producted-part-2', null, { filterInput: JSON.stringify(this.filterInput) });
    }
        ...
        this.poProductedPartDetailService
			...
			.subscribe((res) => {
				if (res['Result'] != '0') {
					...
					this.updateSuccess();
                    // CM_ATTACH_FILE
					this.updateFile(this.inputModel, 'po-producted-part-2', undefined,this.inputModel.pO_PRODUCTED_PART_ID);
                    this.getPoProductedPartDetail();
                    this.updateView();
				}
			});
    ...
    onStartProductedPart(){
        abp.ui.setBusy()
        this.poProductedPartDetailService
			.pO_PRODUCTED_PART_DETAIL_Start(this.inputModel.pO_ID, "CD2", "Định hình")
