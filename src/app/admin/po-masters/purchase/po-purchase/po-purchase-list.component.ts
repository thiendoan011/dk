...
@Component({
    templateUrl: './po-purchase-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoPurchaseListComponent extends ListComponentBase<PO_PURCHASE_ENTITY> implements IUiAction<PO_PURCHASE_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoPurchase', true, true, false, true, true, true, false, true);
        this.appToolbar.setEnableForListPage();

        this.branchName = this.appSession.user.branchName;
        this.filterInput.purchasE_PROCESS = 'B';
        this.filterInput.purchasE_TYPE = 'I';
        this.updateView();
    }
    ...
    onAdd(): void {
        this.navigatePassParam('/app/admin/po-purchase-add', null, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onUpdate(item: PO_PURCHASE_ENTITY): void {
        this.navigatePassParam('/app/admin/po-purchase-edit', { id: item.purchasE_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: PO_PURCHASE_ENTITY): void {
        this.navigatePassParam('/app/admin/po-purchase-view', { id: item.purchasE_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
