...
@Component({
    templateUrl: './po-purchase-veneer-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoPurchaseVeneerListComponent extends ListComponentBase<PO_PRODUCTED_PART_VENEER_ENTITY> implements IUiAction<PO_PRODUCTED_PART_VENEER_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoPurchaseVeneer', true, true, false, true, true, true, false, true);
        this.appToolbar.setEnableForListPage();
        this.filterInput.typE_SEARCH = 'PURCHASE';
    }
    ...
    onUpdate(item: PO_PRODUCTED_PART_VENEER_ENTITY): void {
        this.navigatePassParam('/app/admin/po-purchase-veneer-edit', { id: item.pO_PRODUCTED_PART_VENEER_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: PO_PRODUCTED_PART_VENEER_ENTITY): void {
        this.navigatePassParam('/app/admin/po-purchase-veneer-view', { id: item.pO_PRODUCTED_PART_VENEER_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
