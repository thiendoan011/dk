...
@Component({
    templateUrl: './po-purchase-state-veneer-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PoPurchaseStateVeneerListComponent extends ListComponentBase<PO_PRODUCTED_PART_VENEER_ENTITY> implements IUiAction<PO_PRODUCTED_PART_VENEER_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PoPurchaseStateVeneer', true, true, false, true, true, true, false, true);
        this.appToolbar.setEnableForListPage();
        this.filterInput.typE_SEARCH = 'PURCHASE_STATE';
    }
    ...
    onUpdate(item: PO_PRODUCTED_PART_VENEER_ENTITY): void {
        this.navigatePassParam('/app/admin/po-purchase-state-veneer-edit', { id: item.pO_PRODUCTED_PART_VENEER_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: PO_PRODUCTED_PART_VENEER_ENTITY): void {
        this.navigatePassParam('/app/admin/po-purchase-state-veneer-view', { id: item.pO_PRODUCTED_PART_VENEER_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
