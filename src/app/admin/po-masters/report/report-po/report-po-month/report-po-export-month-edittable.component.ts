...
@Component({
    selector: 'report-po-export-month-edittable',
	templateUrl: './report-po-export-month-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ReportPOExportMonthEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_PO_EXPORT_MONTH.xlsx";
        reportInfo.storeName = "PO_REPORT_PO_EXPORT_MONTH";
