...
@Component({
    selector: 'report-po-booking-month-edittable',
	templateUrl: './report-po-booking-month-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ReportPOBookingMonthEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_PO_BOOKING_MONTH.xlsx";
        reportInfo.storeName = "PO_REPORT_PO_BOOKING_MONTH";
