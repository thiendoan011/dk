...
@Component({
    selector: 'report-po-export-week-edittable',
	templateUrl: './report-po-export-week-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ReportPOExportWeekEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_PO_EXPORT_WEEK.xlsx";
        reportInfo.storeName = "PO_REPORT_PO_EXPORT_WEEK";
