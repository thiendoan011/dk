...
@Component({
    selector: 'report-po-modified-exportdate-week-edittable',
	templateUrl: './report-po-modified-exportdate-week-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ReportPOModifiedExportdateWeekEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_PO_MODIFIED_EXPORTDATE_WEEK.xlsx";
        reportInfo.storeName = "PO_REPORT_PO_MODIFIED_EXPORTDATE_WEEK";
