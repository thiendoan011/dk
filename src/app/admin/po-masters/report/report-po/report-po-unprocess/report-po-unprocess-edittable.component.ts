...
@Component({
    selector: 'report-po-unprocess-edittable',
	templateUrl: './report-po-unprocess-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ReportPOUnprocessEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    ngOnInit(): void {
        ...
        this.filterInput.PRODUCTED_PART_CODE = 'CD1';
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_PO_UNPROCESS.xlsx";
        reportInfo.storeName = "PO_REPORT_PO_UNPROCESS";
