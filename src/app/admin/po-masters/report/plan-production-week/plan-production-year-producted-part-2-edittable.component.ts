...
@Component({
    selector: 'plan-production-year-producted-part-2-edittable',
	templateUrl: './plan-production-year-producted-part-2-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PlanProductionYearProductedPart2EdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel_Week_Of_Year(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/PO_RPT_PLAN_WEEK_OF_YEAR_PRODUCTED_PART_2.xlsx";
        reportInfo.storeName = "PO_RPT_PLAN_WEEK_OF_YEAR_PRODUCTED_PART_2";
