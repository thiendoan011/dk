...
@Component({
    selector: 'plan-production-year-producted-part-345-edittable',
	templateUrl: './plan-production-year-producted-part-345-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PlanProductionYearProductedPart345EdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel_Week_Of_Year(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/PO_RPT_PLAN_WEEK_OF_YEAR_PRODUCTED_PART_345.xlsx";
        reportInfo.storeName = "PO_RPT_PLAN_WEEK_OF_YEAR_PRODUCTED_PART_345";
