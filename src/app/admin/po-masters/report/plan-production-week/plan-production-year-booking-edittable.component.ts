...
@Component({
    selector: 'plan-production-year-booking-edittable',
	templateUrl: './plan-production-year-booking-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PlanProductionYearBookingEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel_Week_Of_Year(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/PO_RPT_PLAN_WEEK_OF_YEAR_BOOKING.xlsx";
        reportInfo.storeName = "PO_RPT_PLAN_WEEK_OF_YEAR_BOOKING";
