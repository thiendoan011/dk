...
@Component({
    selector: 'plan-production-year-edittable',
	templateUrl: './plan-production-year-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PlanProductionYearEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel_Week_Of_Year(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/PO_RPT_PLAN_WEEK_OF_YEAR.xlsx";
        reportInfo.storeName = "PO_RPT_PLAN_WEEK_OF_YEAR";
