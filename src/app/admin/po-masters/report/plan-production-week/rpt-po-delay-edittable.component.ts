...
@Component({
    selector: 'rpt-po-delay-edittable',
	templateUrl: './rpt-po-delay-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class RptPODelayEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/PO_RPT_DELAY.xlsx";
        reportInfo.storeName = "PO_RPT_DELAY";
