...
@Component({
    selector: 'rpt-po-dailykpi-edittable',
	templateUrl: './rpt-po-dailykpi-edittable.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class RptPODailyKPIEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/PO_RPT_DAILYKPI.xlsx";
        reportInfo.storeName = "PO_RPT_DAILYKPI";
