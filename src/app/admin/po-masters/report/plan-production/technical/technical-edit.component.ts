...
export class PORPPTechnicalEditComponent extends DefaultComponentBase implements OnInit, AfterViewInit, IUiActionEdit<R_ENTITY> {
//#region constructor
    constructor(
        injector: Injector,
    ...
    ngOnInit(): void {
        switch (this.editPageState) {
            case EditPageState.add:
                this.appToolbar.setRole('PORPPTechnical', false, false, true, false, false, false, false, false);
            ...
            case EditPageState.viewDetail:
                this.appToolbar.setRole('PORPPTechnical', false, false, false, false, false, false, true, false);
...
//#region CRUD    
    goBack() {
        this.navigatePassParam('/app/admin/porpp-technical', null, { filterInput: JSON.stringify(this.filterInput) });
    }
    ...
    onUpdate(): void {
        this.inputModel.typE_UPDATE_PLAN_PRODUCTION = 'TECHNICAL';
        this.saving = true;
