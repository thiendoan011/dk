...
@Component({
    templateUrl: './project-development-edit.component.html',
    animations: [appModuleAnimation()]
})
export class PORPPProjectDevelopmentEditComponent extends DefaultComponentBase implements OnInit, AfterViewInit, IUiActionEdit<R_ENTITY> {
//#region constructor
    constructor(
        injector: Injector,
    ...
    ngOnInit(): void {
        switch (this.editPageState) {
            case EditPageState.add:
                this.appToolbar.setRole('PORPPProjectDevelopment', false, false, true, false, false, false, false, false);
            ...
            case EditPageState.viewDetail:
                this.appToolbar.setRole('PORPPProjectDevelopment', false, false, false, false, false, false, true, false);
...
//#region CRUD    
    goBack() {
        this.navigatePassParam('/app/admin/porpp-project-development', null, { filterInput: JSON.stringify(this.filterInput) });
    }
    ...
    onUpdate(): void {
        this.inputModel.typE_UPDATE_PLAN_PRODUCTION = 'PROJECT_DEVELOPMENT';
        this.saving = true;
