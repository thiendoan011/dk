...
@Component({
    templateUrl: './project-development-list.component.html',
    animations: [appModuleAnimation()]
})

export class PORPPProjectDevelopmentListComponent extends ListComponentBase<R_REPORT_DTO> implements IUiActionList<R_REPORT_DTO>, OnInit, AfterViewInit {
...
//#region constructor
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PORPPProjectDevelopment', true, true, false, true, true, true, false, true);
        this.appToolbar.setEnableForListPage();
        this.filterInput.r_TYPE = 'lsx90';
        this.filterInput.typE_REPORT = 'PDE';
...
//#region search and navigation
    ...
    onUpdate(item: R_REPORT_DTO): void {
        this.navigatePassParam('/app/admin/porpp-project-development-edit', { id: item.r_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onViewDetail(item: R_REPORT_DTO): void {
        this.navigatePassParam('/app/admin/porpp-project-development-view', { id: item.r_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
...
//#endregion combobox and default filter
    ...
    onExportTemplate(type: string){
        ...
        reportInfo.pathName = '/R/R_PLAN_PRODUCTION_UPD_IMPORT_PDE.xlsx';
    ...
    xlsStructure = [
        ...
        'pdE_PRODUCT_PROFILE_REQUEST_EXACT_DT',
        'pdE_PRODUCT_PROFILE_REQUEST_STATUS',
        'pdE_PRODUCT_PROFILE_REQUEST_SUBJECTIVE_REASONS',
        'pdE_PRODUCT_PROFILE_REQUEST_OBJECTIVE_REASONS',
        'pdE_PRODUCT_PROFILE_REQUEST_REMEDIATION'
	];
    onUpdateImport(rows: any) {
        ...
        this.importFilterInput.type = 'PDE';
