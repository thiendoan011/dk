...
@Component({
    selector: 'po-report-data-extraction-r-purchase',
	templateUrl: './po-report-data-extraction-r-purchase.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionRPurchaseComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_R_PURCHASE.xlsx";
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_R_PURCHASE";
