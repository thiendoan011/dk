...
@Component({
    selector: 'po-report-data-extraction-producted-part',
	templateUrl: './po-report-data-extraction-producted-part.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionProductedPartComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(type: string){
        ...
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_PRODUCTED_PART";
        if(type == 'DETAIL'){
            reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PRODUCTED_PART_DETAIL.xlsx";
        }
        else if(type == 'GROUPBY'){
            reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PRODUCTED_PART_GROUPBY.xlsx";
        }
        else if(type == 'TOTAL'){
            reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PRODUCTED_PART_TOTAL.xlsx";
        }
