...
@Component({
    selector: 'po-report-data-extraction-producted-part-factory',
	templateUrl: './po-report-data-extraction-producted-part-factory.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionProductedPartFactoryComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PRODUCTED_PART_FACTORY.xlsx";
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_PRODUCTED_PART_FACTORY";
