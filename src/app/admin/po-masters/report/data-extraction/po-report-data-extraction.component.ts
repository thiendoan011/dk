...
@Component({
    templateUrl: './po-report-data-extraction.component.html',
    animations: [appModuleAnimation()]
})

export class POReportDataExtractionComponent extends ListComponentBase<PO_PRODUCTED_PART_ENTITY> implements OnInit, AfterViewInit {
