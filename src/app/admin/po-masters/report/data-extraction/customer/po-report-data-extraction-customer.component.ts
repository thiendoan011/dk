...
@Component({
    selector: 'po-report-data-extraction-customer',
	templateUrl: './po-report-data-extraction-customer.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionCustomerComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_CUSTOMER";
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_CUSTOMER.xlsx";
