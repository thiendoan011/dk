...
@Component({
    selector: 'po-report-data-extraction-group-product',
	templateUrl: './po-report-data-extraction-group-product.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionGroupProductComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.parameters = this.GetParamsFromFilter({
            ...
            CUSTOMER_CODE: this.filterInput.CUSTOMER_CODE,
            GROUP_PRODUCT_CODE: this.filterInput.GROUP_PRODUCT_CODE,
            FRM_DATE: this.filterInput.FRM_DATE,
            TO_DATE: this.filterInput.TO_DATE
        });
        
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_GROUP_PRODUCT";
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_GROUP_PRODUCT.xlsx";
