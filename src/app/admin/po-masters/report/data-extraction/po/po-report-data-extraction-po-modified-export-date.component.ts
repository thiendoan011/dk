...
@Component({
    selector: 'po-report-data-extraction-po-modified-export-date',
	templateUrl: './po-report-data-extraction-po-modified-export-date.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionPOModifiedExportDateComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    exportToExcel(){
        ...
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_PO_MODIFIED_EXPORT_DATE";
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PO_MODIFIED_EXPORT_DATE.xlsx";
    ...
    exportToExcelQuantity(){
        ...
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_PO_MODIFIED_EXPORT_DATE_QUANTITY";
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PO_MODIFIED_EXPORT_DATE_QUANTITY.xlsx";
