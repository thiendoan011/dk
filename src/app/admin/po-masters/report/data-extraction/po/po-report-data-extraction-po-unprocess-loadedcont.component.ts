...
@Component({
    selector: 'po-report-data-extraction-po-unprocess-loadedcont',
	templateUrl: './po-report-data-extraction-po-unprocess-loadedcont.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class POReportDataExtractionPOUnprocessLoadedcontComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    ngOnInit(): void {
        ...
        this.filterInput.PO_PROCESS = 'A';
        this.filterInput.PO_LOAD_CONT_STATUS = 'A';
    ...
    exportToExcel(){
        ...
        reportInfo.parameters = this.GetParamsFromFilter({
            ...
            PO_LOAD_CONT_STATUS: this.filterInput.PO_LOAD_CONT_STATUS,
            FRM_DATE: this.filterInput.FRM_DATE,
            TO_DATE: this.filterInput.TO_DATE
        });
        
        reportInfo.storeName = "PO_REPORT_DATA_EXTRACTRION_PO_UNPROCESS_LOADEDCONT";
        reportInfo.pathName = "/PO_MASTER/REPORT/REPORT_PO/PO_REPORT_DATA_EXTRACTRION_PO_UNPROCESS_LOADEDCONT.xlsx";
