...
@Component({
    selector: 'dashboard-plan-embryo-tbl1-edittable',
	templateUrl: './dashboard-plan-embryo-tbl1-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class DashboardPlanEmbryoTbl1EdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
