...
@Component({
    selector: 'product-group-detail-product-detail-edittable',
	templateUrl: './product-detail-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ProductGroupDetailProductDetailEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
...
//#endregion "Constructor"    
    ...
    onViewProductDetail(item){
        window.open("/app/admin/product-detail-view;id="+ item.producT_DETAIL_ID);
    }
}