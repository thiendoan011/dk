...
@Component({
    selector: 'product-product-detail-material-nn-edittable',
	templateUrl: './product-product-detail-material-nn-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class ProductProductDetailMaterialNNEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
