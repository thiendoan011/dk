...
//#region Export Excel
    exportToExcel(type_export: string){
        ...
        if(type_export == 'BCT_NN'){
            reportInfo.pathName = "/PRODUCT/PRODUCT/PRODUCT_PRODUCT_GROUP_DETAIL_NN.xlsx";
            reportInfo.storeName = "PRODUCT_PRODUCT_EXPORT_EXCEL";
        }
        else if(type_export == 'BCT_VENEER'){
            reportInfo.pathName = "/PRODUCT/PRODUCT/PRODUCT_PRODUCT_GROUP_DETAIL_VENEER.xlsx";
            reportInfo.storeName = "PRODUCT_PRODUCT_EXPORT_EXCEL";
        }
        else if(type_export == 'BCT_PAINT'){
            reportInfo.pathName = "/PRODUCT/PRODUCT/PRODUCT_PRODUCT_GROUP_DETAIL_PAINT.xlsx";
            reportInfo.storeName = "PRODUCT_PRODUCT_EXPORT_EXCEL";
        }
        else if(type_export == 'HSSP'){
            reportInfo.pathName = "/PRODUCT/PRODUCT/PRODUCT_PRODUCT_GROUP_DETAIL_HSSP.xlsx";
            reportInfo.storeName = "PRODUCT_PRODUCT_EXPORT_EXCEL";
        }
        else if(type_export == 'BCT_HARDWARE'){
            reportInfo.pathName = "/PRODUCT/PRODUCT/PRODUCT_PRODUCT_GROUP_DETAIL_HARDWARE.xlsx";
            reportInfo.storeName = "PRODUCT_PRODUCT_EXPORT_EXCEL";
        }
