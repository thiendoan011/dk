...
@Component({
    templateUrl: './pur-requisition-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class PURRequisitionListComponent extends ListComponentBase<PUR_REQUISITION_ENTITY> implements IUiActionList<PUR_REQUISITION_ENTITY>, OnInit, AfterViewInit {
...
//#region constructor
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('PURRequisition', true, true, false, true, true, true, false, true);
...
//#region search and navigation
    ...
    onAdd(): void {
        this.navigatePassParam('/app/admin/pur-requisition-add', null, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onUpdate(item: PUR_REQUISITION_ENTITY): void {
        this.navigatePassParam('/app/admin/pur-requisition-edit', { id: item.puR_REQUISITION_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onViewDetail(item: PUR_REQUISITION_ENTITY): void {
        this.navigatePassParam('/app/admin/pur-requisition-view', { id: item.puR_REQUISITION_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
