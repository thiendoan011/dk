...
@Component({
    selector: 'pur-requisition-material-summary-edittable',
	templateUrl: './pur-requisition-material-summary-edittable.component.html'
})

export class PURRequisitionMaterialSummaryEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
