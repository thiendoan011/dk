...
@Component({
    selector: 'pur-requisition-material-summary-purchased-edittable',
	templateUrl: './pur-requisition-material-summary-purchased-edittable.component.html'
})

export class PURRequisitionMaterialSummaryPurchasedEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
