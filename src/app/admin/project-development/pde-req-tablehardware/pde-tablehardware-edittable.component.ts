...
@Component({
    selector: 'pde-tablehardware-edittable',
	templateUrl: './pde-tablehardware-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PDETablehardwareEditTableComponent extends DefaultComponentBase implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
...
//#endregion "Constructor"    
    ...
    pdE_GROUP_PRODUCT_HARDWARE_Upd(){
        ...
        this.pdeGroupProductService
            .pDE_GROUP_PRODUCT_TABLEHARDWARE_Upd(this.inputModel)
    ...
    pdE_GROUP_PRODUCT_HARDWARE_Edit(){
		abp.ui.setBusy();
        this.inputModel.pdE_GROUP_PRODUCT_TABLEHARDWAREs = this.editTable.allData;
        this.pdeGroupProductService
            .pDE_GROUP_PRODUCT_TABLEHARDWARE_Edit(this.inputModel)
            .pipe(finalize(() => {abp.ui.clearBusy();}))
            .subscribe((res) => {
                if (res['Result'] != '0') {
                    this.showErrorMessage(res['ErrorDesc']);
