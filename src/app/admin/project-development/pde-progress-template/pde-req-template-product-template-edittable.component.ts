...
@Component({
    selector: 'pde-req-template-product-template-edittable',
	templateUrl: './pde-req-template-product-template-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PDEReqTemplateProductTemplateEditTableComponent extends DefaultComponentBase implements AfterViewInit {
//#region "Constructor"
    constructor(
        injector: Injector,
    ) {
