...
import { PO_COSTSTATEMENT_HISTORY_ENTITY, PO_COSTSTATEMENT_ENTITY, PO_PRODUCT_ENTITY, PoCoststatementServiceProxy, PO_GROUP_PRODUCT_ENTITY } from "@shared/service-proxies/service-proxies";

@Component({
    selector: 'pde-choose-request-edittable',
	templateUrl: './pde-choose-request-edittable.component.html',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: [ appModuleAnimation() ]
})

export class PDEChooseRequestEdittableComponent extends ChangeDetectionComponent implements AfterViewInit {
