...
import { DepartmentServiceProxy, CM_DEPARTMENT_ENTITY, CM_BRANCH_ENTITY, BranchServiceProxy, UltilityServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class DepartmentEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_DEPARTMENT_ENTITY>, AfterViewInit {
    constructor(
        injector: Injector,
    ...
    goBack() {
        this.navigatePassParam('/app/admin/department', null, undefined);
    }
