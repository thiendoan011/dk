...
export class AllCodeListComponent extends ListComponentBase<CM_ALLCODE_ENTITY> implements IUiAction<CM_ALLCODE_ENTITY>, OnInit, AfterViewInit {
    ...
    onUpdate(item: CM_ALLCODE_ENTITY): void {
        this.navigatePassParam('/app/admin/all-code-edit', { id: item.id }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: CM_ALLCODE_ENTITY): void {
        this.navigatePassParam('/app/admin/all-code-view', { id: item.id }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
