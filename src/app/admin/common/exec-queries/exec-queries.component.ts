...
import { ExecQueryServiceProxy, ExecQueryDto } from 'shared/service-proxies/service-proxies';
...
export class ExecQueryComponent extends ChangeDetectionComponent implements OnInit {
    ...
    constructor(
        private execQueryServiceProxy: ExecQueryServiceProxy,
    ...
    onSubmit() {
        ...
        this.execQueryServiceProxy.execQuery(entity).subscribe(
            res => {
