...
export class BranchListComponent extends ListComponentBase<CM_BRANCH_ENTITY> implements IUiAction<CM_BRANCH_ENTITY>, OnInit, AfterViewInit {
    ...
    onUpdate(item: CM_BRANCH_ENTITY): void {
        this.navigatePassParam('/app/admin/branch-edit', { id: item.brancH_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: CM_BRANCH_ENTITY): void {
        this.navigatePassParam('/app/admin/branch-view', { id: item.brancH_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
