...
import { BranchServiceProxy, CM_BRANCH_ENTITY, UltilityServiceProxy } from '@shared/service-proxies/service-proxies';
...
import { AllCodeSelectComponent } from '@app/admin/core/controls/common/allCodes/all-code-select.component';
...
export class BranchEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_BRANCH_ENTITY>, AfterViewInit {
    ...
    initCombobox() {
        this.branchService.cM_BRANCH_GetFatherList('', '').subscribe(response => {
