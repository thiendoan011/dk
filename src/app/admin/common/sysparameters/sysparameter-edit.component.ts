...
export class SysParameterEditComponent extends DefaultComponentBase implements OnInit, IUiAction<SYS_PARAMETERS_ENTITY>, AfterViewInit {
    constructor(
        injector: Injector,
    ...
    goBack() {
        this.navigatePassParam('/app/admin/argument', null, undefined);
    }
