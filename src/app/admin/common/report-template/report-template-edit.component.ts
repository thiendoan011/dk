import { Component, Injector, ViewChild, Output, OnInit, ViewEncapsulation, ElementRef, AfterViewInit } from '@angular/core';
import { appModuleAnimation } from '@shared/animations/routerTransition';
import * as _ from 'lodash';
import { ReportTemplateServiceProxy, CM_REPORT_TEMPLATE_ENTITY, AppMenuDto, RoleListDto, UltilityServiceProxy, CM_REPORT_TEMPLATE_DETAIL_ENTITY, ReportInfo, AsposeServiceProxy as ReportServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class ReportTemplateEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_REPORT_TEMPLATE_ENTITY>, AfterViewInit {
    ...
    goBack() {
        this.navigatePassParam('/app/admin/reporttemplate', null, undefined);
    }
