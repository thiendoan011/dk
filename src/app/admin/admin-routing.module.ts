		...
		RouterModule.forChild([
			{
				...
				children: [
					...
					// ,{
					// 	path: 'car',
					// 	loadChildren: 'app/admin/car-masters/car-master.module#CarMasterModule', //Lazy load admin module
					// 	data: { preload: false },
					// 	canLoad: [AppRouteGuard]
					// },
					// {
					// 	path: 'report',
					// 	loadChildren: 'app/admin/reports/report.module#ReportModule', //Lazy load admin module
					// 	data: { preload: false },
					// 	canLoad: [AppRouteGuard]
					// },
					// {
					// 	path: 'ass',
					// 	loadChildren: 'app/admin/ass-masters/ass-master.module#AssMasterModule', //Lazy load admin module
					// 	data: { preload: false },
					// 	canLoad: [AppRouteGuard]
					// }
				]
