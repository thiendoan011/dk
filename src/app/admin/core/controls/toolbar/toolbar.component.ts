...
export class ToolbarComponent extends AppComponentBase implements OnInit {
    ...
    uiActionList: IUiActionList<any>;
    uiActionEdit: IUiActionEdit<any>;
    ...
    public setUiActionList(uiActionList: IUiActionList<any>): void {
        this.uiActionList = uiActionList;
    }

    public setUiActionEdit(uiActionEdit: IUiActionEdit<any>): void {
        this.uiActionEdit = uiActionEdit;
    }
    ...
    public setEnableForDashboardPage(): void {
        this.setButtonAddEnable(false);
        this.setButtonUpdateEnable(false);
        this.setButtonSaveEnable(false);
        this.setButtonViewDetailEnable(false);
    ...
    add(): void {
        ...
        else if (this.uiActionList) {
            this.uiActionList.onAdd();
        }
        else if (this.uiActionEdit) {
            this.uiActionEdit.onAdd();
        }
    }
    ...
    update(): void {
        ...
        else if (this.selectedItem && this.uiActionList) {
            this.uiActionList.onUpdate(this.selectedItem);
        }
        else if (this.selectedItem && this.uiActionEdit) {
            this.uiActionEdit.onUpdate(this.selectedItem);
        }
    }
    ...
    delete(): void {
        if (this.selectedItem && this.uiAction) {
            ...
            this.uiActionList.onDelete(this.selectedItem);
        }
    }
    ...
    viewDetail(): void {
        if (this.selectedItem && this.uiAction) {
            ...
            this.uiActionList.onViewDetail(this.selectedItem);
        }
    }
    ...
    resetSearch(): void {
        ...
        if (this.uiActionList) {
            this.uiActionList.onResetSearch();
        }
    }
    ...
    approve(): void {
        if (this.uiAction) {
            ...
            this.uiActionEdit.onApprove(this.selectedItem);
        }
    }
    ...
    save(): void {
        ...
        if (this.uiActionEdit) {
            this.uiActionEdit.onSave();
        }
    }
}
