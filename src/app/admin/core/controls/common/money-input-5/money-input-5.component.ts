...
@Component({
    selector: "money-input-5",
    templateUrl: "./money-input-5.component.html",
    encapsulation: ViewEncapsulation.None,
    providers: [createCustomInputControlValueAccessor(MoneyInput5Component)]
})

export class MoneyInput5Component extends ControlComponent implements OnInit {
    ...
    @Input() isDecimal_round3 = false;
    @Input() isDecimal_round4 = false;
    @Input() isDecimal_round5 = false;
    ...
    moneyTextToNumber(moneyText) {
        ...
        else if(this.isDecimal_round3){
            return super.moneyTextToNumberFRound3(moneyText);
        }
        else if(this.isDecimal_round4){
            return super.moneyTextToNumberFRound4(moneyText);
        }
        else if(this.isDecimal_round5){
            return super.moneyTextToNumberFRound5(moneyText);
        }
        else {
    ...
    onKeyPress(event) {
        ...
        if (value > 0 && !this.isDecimal && !this.isDecimal_round2 && !this.isDecimal_round3 && !this.isDecimal_round4 && !this.isDecimal_round5) {
