...
// TODO: Replace with Angular 19 compatible scrollbar solution
...
export const commonDeclarationImports = [
    ...
    // Note: ngx-bootstrap modules (ModalModule, TabsModule, TooltipModule, etc.) 
    // are already imported with .forRoot() in the root module and should not be re-imported here
    // Note: AppCommonModule has its own .forRoot() configuration and should be imported separately
];
