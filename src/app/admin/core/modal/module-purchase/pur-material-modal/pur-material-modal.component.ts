...
@Component({
    selector: "pur-material-modal",
    templateUrl: "./pur-material-modal.component.html",
    encapsulation: ViewEncapsulation.None
})
export class PURMaterialModalComponent extends PopupBaseComponent<PUR_MATERIAL_ENTITY> {
    ...
    async getResult(checkAll: boolean = false): Promise<any> {
        ...
        var result = await this.purSearchService.pUR_MATERIAL_Search(this.filterInputSearch)
