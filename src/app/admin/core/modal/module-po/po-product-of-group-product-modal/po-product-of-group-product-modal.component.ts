...
@Component({
    selector: "po-product-of-group-product-modal",
    templateUrl: "./po-product-of-group-product-modal.component.html",
    encapsulation: ViewEncapsulation.None
})
export class PoProductOfGroupProductModalComponent extends PopupBaseComponent<PO_PRODUCT_ENTITY> {
    ...
    async getResult(checkAll: boolean = false): Promise<any> {
        ...
        var result = await this.poGroupProductService.pO_GET_PRODUCT_OF_PO_GROUP_PRODUCT_Byid(this.filterInputSearch)
