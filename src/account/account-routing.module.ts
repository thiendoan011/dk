...
import { LoginAdfsSuccessComponent as LoginAdfsFailComponent } from './login-adfs-success/login-adfs-fail.component';
        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'login-adfs-fail', component: LoginAdfsFailComponent, canActivate: [AccountRouteGuard] },
