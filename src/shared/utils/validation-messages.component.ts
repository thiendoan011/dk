...
export class ValidationMessagesComponent {
    ...
    getErrorDefinitionMessage(errorDef: ErrorDef): string {
        ...
        return !!errorRequirement
            ? this.labelName + ' ' + this.appLocalizationService.l(errorDef.localizationKey, errorRequirement)
            : this.labelName + ' ' + this.appLocalizationService.l(errorDef.localizationKey);
    }
}
