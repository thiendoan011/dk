...
import { APP_INITIALIZER, Injector, LOCALE_ID, NgModule, TemplateRef, ApplicationRef } from '@angular/core';
...
import { PocModule } from '@app/admin/poc/poc.module';
...
function registerLocales(resolve: (value?: boolean | Promise<boolean>) => void, reject: any) {
    if (shouldLoadLocale()) {
        ...
        import(`@angular/common/locales/${angularLocale}`)
            .then(module => {
