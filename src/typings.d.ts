...
interface JQuery {
    ...
    draggable(option?: any): JQuery;
    droppable(option?: any): JQuery;
    dragtable(option?: any): JQuery;
    sortable(option?: any): JQuery;
    disableSelection(option?: any): JQuery;
    selectable(option?: any): JQuery;
}
...
interface Array<T> {
    ...
    sumWDefault: (callbackfn?: (value: T, index: number, array: T[]) => number, valDefault?: any) => number;
    distinct: () => T[]
}
/**
 * rtl-detect
